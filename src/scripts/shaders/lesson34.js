...
import fireworksVertexShader from '../../shaders/34/fireworks/vertex.glsl'
import fireworksFragmentShader from '../../shaders/34/fireworks/fragment.glsl'
...
const createRandomFirework = () => {
    ...
    color.setHSL(Math.random(), 1, 0.7)//better and brighter colors than rgb
