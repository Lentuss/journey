...
const updateAllMaterials = () => {
    scene.traverse((child) => {
        if (child.isMesh && child.material.isMeshStandardMaterial) {
            ...
            child.castShadow = true //activate shadows to model
...
gui.add(directionalLight.shadow, 'normalBias').min(-0.05).max(0.05).step(0.001).name('NormalBias')
...
directionalLight.shadow.mapSize.set(1024, 1024)//depends on how clear shadow you want to get
