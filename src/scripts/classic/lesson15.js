...
directionalLight.castShadow = true //activate shadow for light
//only directional, spot amd point can cast shadows
//четкость
...
const spotLight = new THREE.SpotLight(0xffffff, 6.6, 10, Math.PI * 0.3)
